...
public class FieldAgent {
    ...
    public void loadRegistries(boolean fromFile) {
        ...
        if (notProvisioned()) {
            LoggingService.logWarning(MODULE_NAME, "not provisioned");
        } else if (controllerNotConnected() && !fromFile) {
            checkIfControllerVerified();
        } else {
    ...
    private void getFogConfig() {
        ...
        if (notProvisioned()) {
            LoggingService.logWarning(MODULE_NAME, "not provisioned");
        } else if (controllerNotConnected()) {
            checkIfControllerVerified();
    ...
    /**
     * checks if Controller has been verified
     */
    private void checkIfControllerVerified() {
