...
public class FieldAgent implements IOFogModule {
    ...
    private JsonObject getFogStatus() {
        return Json.createObjectBuilder()
                ...
                .add("sysAvailableDisk", StatusReporter.getResourceConsumptionManagerStatus().getAvailableDisk())
                .add("sysAvailableMemory", StatusReporter.getResourceConsumptionManagerStatus().getAvailableMemory())
                .add("sysTotalCpu", StatusReporter.getResourceConsumptionManagerStatus().getTotalCpu())
